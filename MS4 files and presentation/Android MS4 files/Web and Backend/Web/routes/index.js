...
//login -> authenticate & get subsequent data (emergency procedures)
//sign up -> push data onto database
//update_procedures -> save the new emergency procedures
...
router.post("/register_notification_token", function (req, res) {
    ...
    let sql = `
    select * from Users
     where email = mail and pass = passw`;        //user info
